...
public class FormKitchen {
	...
	private void initialize() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (potato == null) {
					JOptionPane.showMessageDialog(null, "Êàðòîøêè òî íåò, ÷òî ÷èñòèòü?", "Îøèáêà ëîãèêè",
							0, null);
					return;
				}
				if (potato.length == 0) {
				...
				JOptionPane.showMessageDialog(null, "Êàðòîøêó  ìîæíî äîáàâëÿòü â êàñòðþëþ", "Êóõíÿ", 0, null);
			}
		});
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (onion == null) {
					JOptionPane.showMessageDialog(null, "Ëóêà òî íåò, ÷òî ÷èñòèòü?", "Îøèáêà ëîãèêè", 0,
							null);
					return;
				}
				if (onion.length == 0) {
				...
				JOptionPane.showMessageDialog(null, "Ëóê  ìîæíî äîáàâëÿòü â êàñòðþëþ", "Êóõíÿ", 0, null);
			}
		});
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (carrot == null) {
					JOptionPane.showMessageDialog(null, "Ìîðêîâè òî íåò, ÷òî ÷èñòèòü?", "Îøèáêà ëîãèêè",
							0, null);
					return;
				}
				if (carrot.length == 0) {
				...
				JOptionPane.showMessageDialog(null, "Ìîðêîâü  ìîæíî äîáàâëÿòü â êàñòðþëþ", "Êóõíÿ", 0, null);
		...
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Êóðèöó ìîæíî äîáàâëÿòü â êàñòðþëþ", "Êóõíÿ", 0, null);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (potato == null) {
					JOptionPane.showMessageDialog(null, "Êàðòîøêè òî íåò, ÷òî âàðèòü?", "Îøèáêà ëîãèêè",
							0, null);
					return;
				}
				if (potato.length == 0) {
				...
				for (int i = 0; i < potato.length; ++i) {
					...
					if (potato[i].getHave_scin()) {
						JOptionPane.showMessageDialog(null, "Êàðòîøêè íàäî ïî÷èñòèòü", "Îøèáêà ëîãèêè",
								0, null);
						return;
					}
				}
				...
				JOptionPane.showMessageDialog(null, "Êàðòîøêó ïîëîæèëè", "Êóõíÿ", 0, null);
		...
		button_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (onion == null) {
					JOptionPane.showMessageDialog(null, "Ëóêà òî íåò, ÷òî âàðèòü?", "Îøèáêà ëîãèêè", 0,
							null);
					return;
				}
				if (onion.length == 0) {
				...
				for (int i = 0; i < onion.length; ++i) {
					...
					if (onion[i].getHave_scin()) {
						JOptionPane.showMessageDialog(null, "Ëóê íàäî ïî÷èñòèòü", "Îøèáêà ëîãèêè", 0,
								null);
						return;
					}
				}
				...
				JOptionPane.showMessageDialog(null, "Ëóê ïîëîæèëè", "Êóõíÿ", 0, null);
			}
		});
		...
		button_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (carrot == null) {
					JOptionPane.showMessageDialog(null, "Ìîðêîâè òî íåò, ÷òî âàðèòü?", "Îøèáêà ëîãèêè",
							0, null);
					return;
				}
				if (carrot.length == 0) {
				...
				for (int i = 0; i < carrot.length; ++i) {
					...
					if (carrot[i].getHave_scin()) {
						JOptionPane.showMessageDialog(null, "Ìîðêîâè íàäî ïî÷èñòèòü", "Îøèáêà ëîãèêè",
								0, null);
						return;
					}
				}
				...
				JOptionPane.showMessageDialog(null, "Ìîðêîâü ïîëîæèëè", "Êóõíÿ", 0, null);
			}
		});
		...
		button_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (lapsha == null) {
					JOptionPane.showMessageDialog(null, "Ëàïøè òî íåò, ÷òî âàðèòü ñîáðàëèñü?", "Îøèáêà ëîãèêè",
							0, null);
					return;
				}

				JOptionPane.showMessageDialog(null, "Ëàïøà â êàñòðþëå", "Êóõíÿ", 0, null);
		...
		button_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (chicken == null) {
					JOptionPane.showMessageDialog(null, "Êóðèöû òî íåò, ÷òî âàðèòü ñîáðàëèñü?", "Îøèáêà ëîãèêè",
							0, null);
					return;
				}
				if (chicken.getcutting()) {
					JOptionPane.showMessageDialog(null, "Êóðèöó íóæíî íàðåçàòü", "Îøèáêà ëîãèêè", 0,
							null);
					return;
				}
				JOptionPane.showMessageDialog(null, "Êóðèöà â êàñòðþëå", "Êóõíÿ", 0, null);
		...
		button_10.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!waterTap.getState()) {
					JOptionPane.showMessageDialog(null, "Âîäû íåò", "Êóõíÿ", 0, null);
					return;
				}
				if(waterTap.getState()){
				...
				JOptionPane.showMessageDialog(null, "Âîäó çàëèëè", "Êóõíÿ", 0, null);
				}
		...
		button_11.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				stove.setPan(pan);
				JOptionPane.showMessageDialog(null, "Êàñòðþëüêà íà ïëèòå", "Êóõíÿ", 0, null);
			}
		});
		...
		button_12.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!stove.pan1()) {
					...
					JOptionPane.showMessageDialog(null, "Ó íàñ íå âñå ãîòîâî ê âàðêå!", "Îøèáêà ëîãèêè",
							0, null);
					return;
				}
				if (!stove.getState()) {
					JOptionPane.showMessageDialog(null, "Âàðèòü ñîáðàëèñü ýíåðãèåé êîñìîñà èëè âñå æå âêëþ÷èì ïëèòó?",
							"Îøèáêà ëîãèêè", 0, null);
					return;
				}
				stove.Cook();
				if (!stove.getPan().Isready()) {
					checkBox_2.setSelected(false);
					JOptionPane.showMessageDialog(null, "ÃÎÒÎÂÎ", "Êóõíÿ", 0, null);
				} else {
					JOptionPane.showMessageDialog(null, "×òî-òî ïîøëî íå òàê", "Îøèáêà ëîãèêè", 0,
							null);
					return;
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!waterTap.getState()) {
				 ...
				 if (!waterTap.State)
		            {
					 JOptionPane.showMessageDialog(null,"Êðàí çàêðûò, êàê ìûòü?", "Îøèáêà ëîãèêè",0,null);
		                return;
		            }
				 ...
				 JOptionPane.showMessageDialog(null,"Êàðòîõó ïîìûëè", "Êóõíÿ", 0,null);
			}
		});
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!waterTap.getState()) {
				 ...
				 JOptionPane.showMessageDialog(null,"Ìîðêîâü ïîìûëè", "Êóõíÿ", 0,null);
			}
		});
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!waterTap.getState()) {
				 ...
				 JOptionPane.showMessageDialog(null,"Ëóê ïîìûëè", "Êóõíÿ", 0,null);
			}
		});
