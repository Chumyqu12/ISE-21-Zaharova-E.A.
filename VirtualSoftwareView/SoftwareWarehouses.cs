...
{
    public partial class SoftwareWarehouses : Form
    {
        [Dependency]
        ...
        public SoftwareWarehouses(ISoftwareWarehouseService service)
        {
            InitializeComponent();
            this.service = service;
        }

        private void SoftwareWarehouses_Load(object sender, EventArgs e)
        {
            LoadData();
        }
