...
namespace VirtualStoreWeb.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public ActionResult Report(string id)
        {
            ...
            DateTime date2 = new DateTime(2018, 6, 13);
            string path = Path.Combine(Server.MapPath("~/"), "ReportViewer.rdlc");
            ...
            ReportDataSource sourceOrders = new ReportDataSource("DataSetOffers", dataSource1);
        ...
        public ActionResult ReportExcel(string id)
        {
            ...
            {
                FileName = Server.MapPath("~/ReportExcel")
            });
            FileStream fs = new FileStream(Server.MapPath("~/ReportExcel.xls"), FileMode.OpenOrCreate, FileAccess.ReadWrite);
            return File(fs, "application/vnd.ms-word", "ReportExcel.xls");
        }
    }
}