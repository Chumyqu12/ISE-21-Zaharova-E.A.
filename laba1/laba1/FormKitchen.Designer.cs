namespace laba1
{
    partial class FormKitchen
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label2.Text = "морковь";
			// 
			// ker
			// 
			this.ker.AutoSize = true;
			this.ker.Location = new System.Drawing.Point(84, 17);
			...
			this.button1.Text = "почистить картошку";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.button1_Click);
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(338, 52);
			this.button2.Margin = new System.Windows.Forms.Padding(2);
			this.button2.Name = "button2";
			this.button2.Size = new System.Drawing.Size(150, 25);
			this.button2.TabIndex = 10;
			this.button2.Text = "почистить морковь";
			...
			this.button3.Text = "почистить лук";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(338, 107);
			this.button5.Margin = new System.Windows.Forms.Padding(2);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(150, 25);
			this.button5.TabIndex = 13;
			this.button5.Text = "нарезать курицу";
			this.button5.UseVisualStyleBackColor = true;
			this.button5.Click += new System.EventHandler(this.button5_Click);
			// 
			// numericUpDown3
			// 
			this.numericUpDown3.Location = new System.Drawing.Point(86, 89);
			...
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(16, 153);
			this.button6.Margin = new System.Windows.Forms.Padding(2);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(128, 38);
			this.button6.TabIndex = 18;
			this.button6.Text = "поставить кострюлю";
			this.button6.UseVisualStyleBackColor = true;
			this.button6.Click += new System.EventHandler(this.button6_Click);
			// 
			// button7
			// 
			this.button7.Location = new System.Drawing.Point(16, 203);
			...
			this.label7.Text = "Кастрюля";
			// 
			// button8
			// 
			this.button8.Location = new System.Drawing.Point(338, 193);
			this.button8.Margin = new System.Windows.Forms.Padding(2);
			this.button8.Name = "button8";
			this.button8.Size = new System.Drawing.Size(128, 19);
			this.button8.TabIndex = 21;
			this.button8.Text = "Залить воду";
			this.button8.UseVisualStyleBackColor = true;
			this.button8.Click += new System.EventHandler(this.button8_Click);
			// 
			// button9
			// 
			this.button9.Location = new System.Drawing.Point(338, 212);
			...
			// button10
			// 
			this.button10.Location = new System.Drawing.Point(338, 237);
			this.button10.Margin = new System.Windows.Forms.Padding(2);
			this.button10.Name = "button10";
			this.button10.Size = new System.Drawing.Size(128, 20);
			this.button10.TabIndex = 23;
			this.button10.Text = "Добавить курицу";
			this.button10.UseVisualStyleBackColor = true;
			this.button10.Click += new System.EventHandler(this.button10_Click);
			// 
			// button11
			// 
			this.button11.Location = new System.Drawing.Point(338, 262);
			...
			// button12
			// 
			this.button12.Location = new System.Drawing.Point(338, 288);
			this.button12.Margin = new System.Windows.Forms.Padding(2);
			this.button12.Name = "button12";
			this.button12.Size = new System.Drawing.Size(128, 20);
			this.button12.TabIndex = 25;
			this.button12.Text = "Добавить морковь";
			this.button12.UseVisualStyleBackColor = true;
			this.button12.Click += new System.EventHandler(this.button12_Click);
			// 
			// button13
			// 
			this.button13.Location = new System.Drawing.Point(338, 313);
			...
			// button14
			// 
			this.button14.Location = new System.Drawing.Point(338, 338);
			this.button14.Margin = new System.Windows.Forms.Padding(2);
			this.button14.Name = "button14";
			this.button14.Size = new System.Drawing.Size(128, 20);
			this.button14.TabIndex = 27;
			this.button14.Text = "Добавить лапшу";
			...
			this.radioButton3.Location = new System.Drawing.Point(75, 133);
			...
			// button15
			// 
			this.button15.Location = new System.Drawing.Point(75, 49);
			...
			this.label9.Text = "курица";
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(207, 85);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(111, 25);
			this.button4.TabIndex = 32;
			this.button4.Text = "помыть картоху";
			this.button4.UseVisualStyleBackColor = true;
			this.button4.Click += new System.EventHandler(this.button4_Click);
			// 
			// button16
			// 
			this.button16.Location = new System.Drawing.Point(207, 121);
			this.button16.Name = "button16";
			this.button16.Size = new System.Drawing.Size(110, 28);
			this.button16.TabIndex = 33;
			this.button16.Text = "помыть морковь";
			this.button16.UseVisualStyleBackColor = true;
			this.button16.Click += new System.EventHandler(this.button16_Click);
			// 
			// button17
			// 
			this.button17.Location = new System.Drawing.Point(211, 161);
			this.button17.Name = "button17";
			this.button17.Size = new System.Drawing.Size(105, 28);
			this.button17.TabIndex = 34;
			this.button17.Text = "помыть лук";
